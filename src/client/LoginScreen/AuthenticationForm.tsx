...
import {FaRegEnvelope, FaEnvelope, FaWallet} from 'react-icons/fa6';
...
import {handleWalletVerified} from '../../actions/auth';
...
const AuthenticationForm: React.FC<AuthenticationFormProps> = (props) => {
    ...
    useEffect(() => {
        if (props.walletVerified) props.handleWalletVerified({
    ...
    return (
        <div className={s.formContainer}>
            ...
            />
            <Button text="Login with email" onClick={handleButton} id="continue"
            ...
            <Button text="Login with wallet" onClick={open} id="continue-wallet"
